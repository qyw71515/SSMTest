...
import com.qyw.test.util.StringUtils;

/**
 * @author：QYW
 * @since：2018年7月11日下午3:36:09
 * @description:
 * @version: 1.0
 * @copyright: Copyright (c)2015
 * @company: 江西航天信息有限公司(jxhtxx.com)
...
public class SessionFilter implements Filter {
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
		...
		if (!StringUtils.equals(myhosts, "127.0.0.1") && !StringUtils.equals(myhosts, "127.0.0.1:8080")
				&& !StringUtils.equals(myhosts, "82.12.66.34") && !StringUtils.equals(myhosts, "82.12.66.34:9004")
				&& !StringUtils.equals(myhosts, "82.12.113.49") && !StringUtils.equals(myhosts, "82.12.113.49:9004")
				&& !StringUtils.equals(myhosts, "82.12.113.50") && !StringUtils.equals(myhosts, "82.12.113.50:9004")
				&& !StringUtils.equals(myhosts, "82.12.113.50:7002")
				&& !StringUtils.equals(myhosts, "82.16.26.202:8080") && !StringUtils.equals(myhosts, "82.16.26.202")
				&& !StringUtils.equals(myhosts, "fpzxtest.jxhtxx.com") && !StringUtils.equals(myhosts, "82.16.26.202")
				&& !StringUtils.equals(myhosts, "fpyj.tunnel.qydev.com") && !StringUtils.equals(myhosts, "82.16.26.202")
				&& !StringUtils.equals(myhosts, "fpyj.tunnel.qydev.com")
